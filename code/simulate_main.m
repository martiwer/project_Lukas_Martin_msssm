function simulate_main(simtime, l_highway, withplot)
% simulate_main(simtime, l_highway, withplot)
            ...
            if(state_2(vehicle_2, itype)==1)
                ...
                for vehicle_1 = n_1:size(state_1,1) 
                    ...
                    if(state_1(vehicle_1, ix) < state_2(vehicle_2, ix))
                        ...
                        if(((state_2(vehicle_2-1, ix) - state_2(vehicle_2, ix) < 200) && (state_2(vehicle_2, iv0) > state_2(vehicle_2-1, iv)) && (state_1(vehicle_a, iv) > state_2(vehicle_2-1, iv)) && ((state_1(vehicle_a, ix) - state_2(vehicle_2, ix))>(state_2(vehicle_2, iv)*3.6/2+s0)) && ((state_2(vehicle_2, ix) - state_1(vehicle_b, ix))>(state_2(vehicle_2, iv)*3.6/2+s0))))
